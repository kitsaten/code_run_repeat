            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="glass-card p-8 rounded-xl">
                        ...
                        <p className="text-4xl font-black text-white mb-4">2,450 <span className="text-lg font-normal text-slate-500">{t("unit_km")}</span></p>
                    ...
                    <div className="glass-card p-8 rounded-xl">
                        ...
                        <p className="text-4xl font-black text-white mb-2">65 <span className="text-lg font-normal text-slate-500">{t("unit_km")}</span></p>
                    ...
                    <div className="glass-card p-8 rounded-xl">
                        ...
                        <p className="text-4xl font-black text-white mb-4">4:30 <span className="text-lg font-normal text-slate-500">{t("unit_pace")}</span></p>
                    ...
                    <div className="glass-card p-8 rounded-xl">
                        ...
                        <p className="text-4xl font-black text-white mb-4">3:15:00</p>
                    ...
                    <div className="glass-card p-8 rounded-xl">
                        ...
                        <p className="text-4xl font-black text-white mb-4">12,450 <span className="text-lg font-normal text-slate-500">{t("unit_m")}</span></p>
                        <div className="flex items-center gap-2 text-primary text-xs font-bold">
                    ...
                    <div className="glass-card p-8 rounded-xl">
                        ...
                        <p className="text-4xl font-black text-white mb-4">14 <span className="text-lg font-normal text-slate-500">{t("unit_days")}</span></p>
                    ...
                    <div className="glass-card p-8 rounded-xl">
                        ...
                        <p className="text-xl font-bold text-white mb-1">12.5 km | 5:10/km</p>
                        <p className="text-slate-500 text-xs font-mono uppercase">2 hours ago</p>
                    </div>
